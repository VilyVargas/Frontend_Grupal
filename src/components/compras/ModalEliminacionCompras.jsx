...
const ModalEliminacionCompras = ({
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        <p>
          ¿Estás seguro de que deseas eliminar la compra del producto{" "}
          <strong>{compraSeleccionada?.Producto}</strong>?
        </p>
      ...
      <Modal.Footer>
        ...
        <Button variant="danger" onClick={confirmarEliminacionCompra}>
